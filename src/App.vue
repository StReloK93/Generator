<template>
  <div class="flex flex-col h-screen w-screen bg-dark-950 text-slate-100 overflow-hidden font-sans select-none">
    ...
    <div class="flex-1 flex overflow-hidden relative">
      <!-- Main Isometric Canvas Viewport with Left Element Driver overlay -->
      <div class="flex-1 flex flex-col h-full relative overflow-hidden">
        ...
        <!-- Bottom Asset Gallery Shelf (Drawer) (Hidden in Game Mode) -->
        <BottomAssetDrawer v-if="!characterStore.isGameMode" />
      </div>

      <!-- Right Placed Elements Outline & Layers Panel (Hidden in Game Mode) -->
      <PlacedElementsPanel 
        v-if="!characterStore.isGameMode"
...
import BottomAssetDrawer from './components/BottomAssetDrawer.vue'
