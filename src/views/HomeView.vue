  ...
  <div class="relative h-screen w-screen bg-slate-950 text-slate-100 flex flex-col justify-between overflow-hidden select-none font-sans px-8 py-4 pt-safe pb-safe">
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex flex-col text-left">
          <div class="flex items-center gap-2">
            ...
            <span class="px-2 py-0.5 rounded-full bg-amber-500/20 border border-amber-400/40 text-[9px] font-black tracking-widest text-amber-300 shadow-[0_0_10px_rgba(245,158,11,0.2)]">
              TD CORE
            </span>
          </div>
    ...
    <main class="relative z-20 flex-1 grid grid-cols-12 gap-8 items-center my-auto w-full max-w-6xl mx-auto min-h-0">
      ...
      <div class="col-span-5 flex flex-col justify-center h-full max-h-[240px]">
        ...
        <div v-if="multiplayerStore.availableRooms.length > 0" class="flex flex-col gap-2.5">
          ...
          <div class="flex flex-col gap-2.5 overflow-y-auto pr-1">
            <div 
              ...
              :key="room.roomId"
              class="group p-3 rounded-2xl bg-gradient-to-r from-slate-900/90 to-slate-950/90 border border-slate-800 hover:border-emerald-500/40 shadow-xl flex items-center justify-between gap-3 transition-all duration-300 backdrop-blur-md"
            >
              ...
              <button 
                @click="router.push('/play')"
                class="px-3.5 py-2 rounded-xl bg-gradient-to-b from-emerald-400 to-emerald-600 hover:brightness-110 border-b-2 border-emerald-950 active:border-b-0 active:translate-y-0.5 text-slate-950 font-black text-[10px] uppercase tracking-wider cursor-pointer shadow-[0_4px_12px_rgba(16,185,129,0.4)] transition-all shrink-0"
              >
                Engage
              </button>
            </div>
        ...
        <div v-else class="relative p-5 rounded-3xl bg-gradient-to-br from-slate-900/90 via-slate-950/95 to-slate-900/90 border border-slate-800/90 shadow-2xl text-left backdrop-blur-md overflow-hidden group">
          ...
          <div class="flex items-center gap-3.5 relative z-10">
            ...
            <div class="text-left">
              <div class="flex items-center gap-2">
                ...
                <span class="px-1.5 py-0.5 rounded bg-cyan-400/20 text-cyan-200 text-[8px] font-black border border-cyan-300/40">
                  EDITOR
                </span>
              </div>
