  ...
  const resolvedTowerBlueprints = rawTowerBlueprints.map((bp: any) => {
    ...
    return {
      ...
      levels: Array.isArray(bp.levels) ? bp.levels.map((lvl: any, idx: number) => ({
        ...
        fireBonusDamage: lvl.fireBonusDamage,
        burnDps: lvl.burnDps,
        burnDuration: lvl.burnDuration,
        slowPercent: lvl.slowPercent,
        slowDuration: lvl.slowDuration,
        frostBonusDamage: lvl.frostBonusDamage,
        poisonDps: lvl.poisonDps,
        poisonDuration: lvl.poisonDuration,
        poisonSlowPercent: lvl.poisonSlowPercent,
        stackBonusDamage: lvl.stackBonusDamage,
        maxStacks: lvl.maxStacks,
        bleedDps: lvl.bleedDps,
        bleedDuration: lvl.bleedDuration,
        electricBonusDamage: lvl.electricBonusDamage,
        chainTargets: lvl.chainTargets,
        stunDuration: lvl.stunDuration,
        voidVulnPercent: lvl.voidVulnPercent,
        voidDuration: lvl.voidDuration,
      })) : undefined,
    }
  })
